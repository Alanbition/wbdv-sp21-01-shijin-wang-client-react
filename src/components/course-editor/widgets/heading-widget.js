...
const HeadingWidget = ({widget, deleteItem, updateItem}) => {
    ...
    return (
        ...
        }
        {
            ...
            <div>
                ...
                <input onChange={(e) => setCachedWidget(widget => ({...cachedWidget, text: e.target.value}))} value={cachedWidget.text} className="form-control"/>
                <select onChange={(e) => setCachedWidget(widget => ({...cachedWidget, size: parseInt(e.target.value)}))} value={cachedWidget.size} className="form-control">
